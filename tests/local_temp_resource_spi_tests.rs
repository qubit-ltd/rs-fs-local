...
/// A confirmed destination conflict retains the native temporary file for retry.
#[test]
...
/// A confirmed destination conflict retains the native temporary directory for retry.
#[test]
